...
var httpGet = function (url, callback) {
  http(false, url, callback)
}

var httpPost = function (url, data, callback) {
  http(false, url, callback, "POST", data)
}

var httpGetLoading = function (url, callback) {
  http(true, url, callback)
}

var httpPostLoading = function (url, data, callback) {
  http(true, url, callback, "POST", data)
}

var http = function (loading, url, callback, method, data) {
  if (loading) {
    wx.showLoading()
  }
  wx.request({
...
module.exports = {
  ...
  httpGet: httpGet,
  httpPost: httpPost,
  httpGetLoading: httpGetLoading,
  httpPostLoading: httpPostLoading,
